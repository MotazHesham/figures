...
if (! function_exists('format_Date')) {
    function format_Date($date) {
        ...
        if($date == null || $date == 0){
            ...
            return date($general_settings->date,$date);
        }
    }
}
if (! function_exists('format_Date_time ')) {
    function format_Date_time ($date) {
        ...
        if($date == null || $date == 0){
            ...
            return date($general_settings->date . ' ' . $general_settings->time,$date);
        }
    }
}

if (! function_exists('delivery_status_function')) {
    function delivery_status_function($status) {
        $class = '';
        if($status == 'pending'){
            $class = 'info';
