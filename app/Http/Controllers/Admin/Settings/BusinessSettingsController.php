...
{
    protected $view = 'admin.settings.business_settings.';

    public function activation(Request $request)
    {
        
    	return view($this->view . 'activation');
    }

    public function social_login(Request $request)
    {
        
        return view($this->view . 'social_login');
    }

    public function smtp_settings(Request $request)
    {
        
        return view($this->view . 'smtp_settings');
    }

    public function google_analytics(Request $request)
    {
        
        return view($this->view . 'google_analytics');
    }

    public function facebook_chat(Request $request)
    {
        
        return view($this->view . 'facebook_chat');
    }
    ...
    {
    	return view($this->view . 'seller_verification_form');
    }
    ...
    public function vendor_commission(Request $request)
    {
        ...
        return view($this->view . 'vendor_commission', compact('business_settings'));
    }
