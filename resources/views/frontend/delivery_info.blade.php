                        ...
                        <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-white py-3">
                                    <h5 class="heading-6 mb-0">{{ \App\Models\GeneralSetting::first()->site_name }} Products</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="cart-item">
                                                        <td class="product-image" width="25%">
                                                            <a href="{{ route('product', \App\Models\Product::find($id)->slug) }}" target="_blank">
                                                                <img loading="lazy"  src="{{ asset(\App\Models\Product::find($id)->thumbnail_img) }}">
                                                            </a>
                                                        </td>
                                                        <td class="product-name strong-600">
                                                            <a href="{{ route('product', \App\Models\Product::find($id)->slug) }}" target="_blank" class="d-block c-base-2">
                            ...
                            @if (!empty($seller_products))
                                @foreach ($seller_products as $key => $seller_product)
                                    <div class="card mb-3">
                                        <div class="card-header bg-white py-3">
                                            <h5 class="heading-6 mb-0">{{ \App\Models\Shop::where('user_id', $key)->first()->name }} Products</h5>
                                        </div>
                                        <div class="card-body">
                                                                ...
                                                                <select class="pickup-select form-control-lg w-100" name="pickup_point_id_{{ $key }}" data-placeholder="Select a pickup point">
                                                                    ...
                                                                    @foreach (json_decode(\App\Models\Shop::where('user_id', $key)->first()->pick_up_point_id) as $pick_up_point)
                                                                        @if (\App\Models\PickupPoint::find($pick_up_point) != null)
                                                                            <option value="{{ \App\Models\PickupPoint::find($pick_up_point)->id }}" data-address="{{ \App\Models\PickupPoint::find($pick_up_point)->address }}" data-phone="{{ \App\Models\PickupPoint::find($pick_up_point)->phone }}">
                                                                                {{ \App\Models\PickupPoint::find($pick_up_point)->name }}
                                                                            </option>
                                                                        @endif
                                                                    @endforeach
                                                                </select>
