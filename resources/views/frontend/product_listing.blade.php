...
@if (isset($subsubcategory_id))
    @php
        $meta_title = \App\Models\SubSubCategory::find($subsubcategory_id)->meta_title;
        $meta_description = \App\Models\SubSubCategory::find($subsubcategory_id)->meta_description;
    @endphp
...
@else
    @php
        ...
        $meta_description = \App\Models\SeoSetting::first()->description;
    @endphp
@endif
                ...
                <div class="col">
                    <ul class="breadcrumb">
                        ...
                        @if (isset($subcategory_id))
                            <li><a
                                    href="{{ route('products.category', \App\Models\SubCategory::find($subcategory_id)->category->slug) }}">{{ \App\Models\SubCategory::find($subcategory_id)->category->name }}</a>
                            </li>
                            <li class="active"><a
                                    href="{{ route('products.subcategory', \App\Models\SubCategory::find($subcategory_id)->slug) }}">{{ \App\Models\SubCategory::find($subcategory_id)->name }}</a>
                            </li>
                        @endif
                        @if (isset($subsubcategory_id))
                            <li><a
                                    href="{{ route('products.category', \App\Models\SubSubCategory::find($subsubcategory_id)->subcategory->category->slug) }}">{{ \App\Models\SubSubCategory::find($subsubcategory_id)->subcategory->category->name }}</a>
                            </li>
                            <li><a
                                    href="{{ route('products.subcategory', \App\Models\SubsubCategory::find($subsubcategory_id)->subcategory->slug) }}">{{ \App\Models\SubsubCategory::find($subsubcategory_id)->subcategory->name }}</a>
                            </li>
                            <li class="active"><a
                                    href="{{ route('products.subsubcategory', \App\Models\SubSubCategory::find($subsubcategory_id)->slug) }}">{{ \App\Models\SubSubCategory::find($subsubcategory_id)->name }}</a>
                            </li>
                        @endif
                    </ul>
                </div>
                        ...
                        <div class="filter-wrapper c-scrollbar">
                                    ...
                                    <div class="category-filter">
                                        <ul>
                                            ...
                                            @if (isset($category_id))
                                                ...
                                                <li class="active"><a
                                                        href="{{ route('products.category', \App\Models\Category::find($category_id)->slug) }}">{{ __(\App\Models\Category::find($category_id)->name) }}</a>
                                                </li>
                                            ...
                                            @if (isset($subcategory_id))
                                                ...
                                                <li class="active"><a
                                                        href="{{ route('products.category', \App\Models\SubCategory::find($subcategory_id)->category->slug) }}">{{ __(\App\Models\SubCategory::find($subcategory_id)->category->name) }}</a>
                                                </li>
                                                <li class="active"><a
                                                        href="{{ route('products.subcategory', \App\Models\SubCategory::find($subcategory_id)->slug) }}">{{ __(\App\Models\SubCategory::find($subcategory_id)->name) }}</a>
                                                </li>
                                            ...
                                            @if (isset($subsubcategory_id))
                                                ...
                                                <li class="active"><a
                                                        href="{{ route('products.category', \App\Models\SubsubCategory::find($subsubcategory_id)->subcategory->category->slug) }}">{{ __(\App\Models\SubSubCategory::find($subsubcategory_id)->subcategory->category->name) }}</a>
                                                </li>
                                                <li class="active"><a
                                                        href="{{ route('products.subcategory', \App\Models\SubsubCategory::find($subsubcategory_id)->subcategory->slug) }}">{{ __(\App\Models\SubsubCategory::find($subsubcategory_id)->subcategory->name) }}</a>
                                                </li>
                                                <li class="current"><a
                                                        href="{{ route('products.subsubcategory', \App\Models\SubsubCategory::find($subsubcategory_id)->slug) }}">{{ __(\App\Models\SubsubCategory::find($subsubcategory_id)->name) }}</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                            ...
                            @foreach ($attributes as $key => $attribute)
                                @if (\App\Models\Attribute::find($attribute['id']) != null)
                                    <div class="bg-white sidebar-box mb-3">
                                        <div class="box-title text-center">
                                            Filter by {{ \App\Models\Attribute::find($attribute['id'])->name }}
                                        </div>
                                        <div class="box-content">
                                            <!-- Filter by others -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control sortSelect"
                                                    ...
                                                    @foreach (\App\Models\Brand::all() as $brand)
                                                        <option value="{{ $brand->slug }}" @isset($brand_id)
                                                            @if ($brand_id == $brand->id) selected @endif @endisset>{{ $brand->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
