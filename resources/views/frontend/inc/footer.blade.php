                ...
                <div class="col-lg-2 col-md-4">
                    <div class="col text-center text-md-left">
                        ...
                        <ul class="footer-links">
                            @foreach (\App\Models\Link::all() as $key => $link)
                                <li>
                ...
                <div class="col-md-4 col-lg-2">
                    <div class="col text-center text-md-left">
                       ...
                       <ul class="footer-links">
                            ...
                            @else
                                <li>
                                    <a href="{{ route('user.login.form') }}" title="Login">
                                        {{__('Login')}}
                                    </a>
                                </li>
                            @endif
            ...
            <div class="row row-cols-xs-spaced flex flex-items-xs-middle">
                ...
                <div class="col-md-4">
                    <ul class="text-center my-3 my-md-0 social-nav model-2">
                        ...
                        @endif
                        @if ($generalsetting->whatsapp != null)
                            <li>
                                <a href="{{ $generalsetting->whatsapp }}" class="whatsapp" target="_blank" data-toggle="tooltip" data-original-title="whatsapp">
                                    <i class="fa fa-whatsapp"></i>
                                </a>
                            </li>
                        @endif
                        @if ($generalsetting->telegram != null)
                            <li>
                                <a href="{{ $generalsetting->telegram }}" class="telegram" target="_blank" data-toggle="tooltip" data-original-title="telegram">
