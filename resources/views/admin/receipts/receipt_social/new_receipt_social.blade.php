...
<head>
    ...
    <title>{{ $receipt_social->order_num }}</title>
...
<body>
    ...
    <div style="position:relative">
        <table class="table table-bordered text-center" style="width:380px;position:absolute;right:10px;top:0" id="price">
            <thead>
                <td>عدد القطع</td>
                <td>المطلوب دفعه</td>
                <td>العربون</td>
        ...
        <table class="table table-bordered text-center" style="width:380px;position:absolute;left:10px;top:0" id="description">
            <thead>
        ...
        <table class="table table-bordered text-center" style="width:380px;position:absolute;top:100px;right:10px" id="client_info">
            <tbody>
                <tr>
    ...
    <div id="second_part" style="position: relative; width:90%;left:40px">
		...
		<table class="table text-center table-borderless" style="width: 270px;float:right">
            <tr>
                <td>تأجيل ليوم</td>
                <td><div style=" border: black 1px solid; display:inline;padding:0px 16px"></div></td>
                <td>تسليم</td>
                <td><div style=" border: black 1px solid; display:inline;padding:0px 16px"></div></td>
            </tr>
            <tr>
	...
	<script>
		window.print()
        var price_and_client_info = $('#price').height() + $('#client_info').height() + 50;
        var description = $('#description').height() + 50;
        if(price_and_client_info > description){
            var first_part = price_and_client_info;
        }else{
            var first_part = description;
        }
        $('#second_part').css('top',first_part + 'px');
	</script>
