    ...
    <div class="panel mb-5">
        <div class="panel-heading" style="padding: 10px;margin-bottom:80px">
            <h3 class="text-center">
                <a class="badge badge-default" href="{{route('receipt.price_view.edit',$receipt->receipt_price_view_id)}}"><i class="fa fa-chevron-circle-left"></i> back</a>
                <br>
                <span class="badge badge-grey">{{$receipt->receipt_price_view->order_num}}</span>
                {{__('Update Receipt')}}
            </h3>
        </div>
        ...
        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('receipt.price_view.update_product') }}" method="POST" enctype="multipart/form-data">
            @csrf
