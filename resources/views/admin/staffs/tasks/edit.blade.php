...
<div class="col-lg-6 col-lg-offset-3">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">{{__('Edit Task')}}</h3>
        </div>

        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('tasks.update',$task->id) }}" method="POST" enctype="multipart/form-data">
        	@csrf
                ...
                <div class="form-group">
                        <select class="form-control demo-select2" name="staff" id="staff" required>
                            ...
                            @foreach($staffs as $staff)
                                    <option value="{{$staff->id}}" @if($task->user_id == $staff->id) selected @endif >{{$staff->email}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="row" style="margin-bottom: 10px">   
                        <div class="col-sm-6 text-center" style="margin-bottom: 10px;">
                            ...
                            <input type="text"  disabled id="start_date_text" value="{{format_Date_time($task->start)}}" class="form-control" style="position: relative;">
                        ...
                        <div class="col-sm-6 text-center" style="margin-bottom: 10px;"> 
                            ...
                            <input type="text" disabled id="end_date_text" value="{{format_Date_time($task->end)}}"  class="form-control" style="position: relative;" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-11">
                            <textarea  class="editor" name="task" required><?php echo $task->task; ?></textarea>
                        </div>
                    </div>
            </div>
